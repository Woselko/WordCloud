...
using WordCloudApplication.Components;
using WordCloudApplication.Components.Account;
using WordCloudApplication.Data;
using WordCloudApplication.Data.Entities;

namespace WordCloudApplication
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddIdentityCore<ApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<WordCloudDbContext>()
                .AddSignInManager()
